"""
Cross-View Localization V3 training with native PyTorch DDP.

This entrypoint mirrors train_detr_v2.py as closely as possible:
- same config parsing and ablation overrides
- same model / criterion / optimizer construction
- same prompt sampling
- same TensorBoard tags
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Cross-View Localizer V3 with native DDP")
