#!/bin/bash
# Terminal grouped evaluation wrapper for ablation_2_contrastive_only.
...
EXPERIMENT_NAME="${3:-ablation_2_contrastive_only}"
MODEL_DIR="${4:-output_v3/ablation_2_contrastive_only}"
