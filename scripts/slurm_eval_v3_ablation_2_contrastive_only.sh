#!/bin/bash
#SBATCH --job-name=cvloc_eval_ab2_ctr
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab2_ctr_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab2_ctr_%j.err
#SBATCH --nodes=1
