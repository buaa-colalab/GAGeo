#!/bin/bash
#SBATCH --job-name=cvloc_v3_ab11_g2s
#SBATCH --output=logs/slurm_v3_ab11_g2s_%j.out
#SBATCH --error=logs/slurm_v3_ab11_g2s_%j.err
#SBATCH --nodes=1
...
bash "${WORKSPACE_DIR}/scripts/slurm_train_accelerate_v3.sh" \
  ...
  --train_subset ground_to_satellite \
  --val_subset ground_to_satellite
