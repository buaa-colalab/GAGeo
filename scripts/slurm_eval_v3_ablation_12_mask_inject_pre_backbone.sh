#!/bin/bash
# Terminal grouped evaluation wrapper for ablation_12_mask_inject_pre_backbone.
...
EXPERIMENT_NAME="${3:-ablation_12_mask_inject_pre_backbone}"
MODEL_DIR="${4:-output_v3/ablation_12_mask_inject_pre_backbone}"
