#!/bin/bash
#SBATCH --job-name=cvloc_eval_ab5_off
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab5_off_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab5_off_%j.err
#SBATCH --nodes=1
...
EXPRIMENT_NAME="ablation_5_all_off"
