...
UNIV_JSON="${RUN_ROOT}/xhj/University-Release/verified_triplets_sam2_masks.json"
UNIV_ROOT="${RUN_ROOT}/xhj/University-Release"
CVOGL_ROOT="${RUN_ROOT}/baseline/CVOS-Code/dataset/CVOGL"
CVOGLSEG_ROOT="${RUN_ROOT}/baseline/CVOS-Code/dataset/CVOGL-Seg"
