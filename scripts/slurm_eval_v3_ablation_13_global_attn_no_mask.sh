#!/bin/bash
# Terminal grouped evaluation wrapper for ablation_13_global_attn_no_mask.
...
EXPERIMENT_NAME="${3:-ablation_13_global_attn_no_mask}"
MODEL_DIR="${4:-output_v3/ablation_13_global_attn_no_mask}"
