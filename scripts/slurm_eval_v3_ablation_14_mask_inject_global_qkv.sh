#!/bin/bash
#SBATCH --job-name=cvloc_eval_ab14_mqkv
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab14_mqkv_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab14_mqkv_%j.err
#SBATCH --nodes=1
...
EXPRIMENT_NAME="${3:-ablation_14_mask_inject_global_qkv}"
