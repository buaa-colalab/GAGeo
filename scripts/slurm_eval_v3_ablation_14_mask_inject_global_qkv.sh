#!/bin/bash
# Terminal grouped evaluation wrapper for ablation_14_mask_inject_global_qkv.
...
EXPERIMENT_NAME="${3:-ablation_14_mask_inject_global_qkv}"
MODEL_DIR="${4:-output_v3/ablation_14_mask_inject_global_qkv}"
