#!/bin/bash
# Terminal grouped evaluation wrapper for ablation_9_wo_contrastive.
...
EXPERIMENT_NAME="${3:-ablation_9_wo_contrastive}"
MODEL_DIR="${4:-output_v3/ablation_9_wo_contrastive}"
