#!/bin/bash
#SBATCH --job-name=cvloc_eval_ab8_dsrot
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab8_dsrot_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab8_dsrot_%j.err
#SBATCH --nodes=1
...
EXPRIMENT_NAME="ablation_8_ds_rotation"
