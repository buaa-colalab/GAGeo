#!/bin/bash
#SBATCH --job-name=cvloc_eval_q2
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_q2_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_q2_%j.err
#SBATCH --nodes=1
...
EXPRIMENT_NAME="ablation_querylen_q2"
MODEL_DIR="output_v3/ablation_querylen/q2"
