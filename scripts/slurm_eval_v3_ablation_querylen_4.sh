#!/bin/bash
#SBATCH --job-name=cvloc_eval_q4
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_q4_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_q4_%j.err
#SBATCH --nodes=1
...
MODEL_DIR="output_v3/ablation_querylen/q4"
