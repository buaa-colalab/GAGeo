#!/bin/bash
#SBATCH --job-name=cvloc_eval_ab6_nohm
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab6_nohm_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab6_nohm_%j.err
#SBATCH --nodes=1
