#!/bin/bash
# Terminal grouped evaluation wrapper for ablation_6_no_heatmap_loss.
...
EXPERIMENT_NAME="${3:-ablation_6_no_heatmap_loss}"
MODEL_DIR="${4:-output_v3/ablation_6_no_heatmap_loss}"
