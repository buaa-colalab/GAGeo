#!/bin/bash
#SBATCH --job-name=cvloc_eval_ab1_ds
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab1_ds_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab1_ds_%j.err
#SBATCH --nodes=1
