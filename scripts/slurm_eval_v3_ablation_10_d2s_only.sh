#!/bin/bash
#SBATCH --job-name=cvloc_eval_ab10_d2s
#SBATCH --output=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab10_d2s_%j.out
#SBATCH --error=/data/home/scxi704/run/eval_logs/slurm_v3_eval_ab10_d2s_%j.err
#SBATCH --nodes=1
...
EXPRIMENT_NAME="${3:-ablation_10_d2s_only}"
