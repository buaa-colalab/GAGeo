#!/bin/bash
#SBATCH --job-name=cvloc_v3_ab6_noheat
#SBATCH --output=logs/slurm_v3_ab6_noheat_%j.out
#SBATCH --error=logs/slurm_v3_ab6_noheat_%j.err
#SBATCH --nodes=1
...
EXPRIMENT_NAME="ablation_6_no_heatmap_loss"
