#!/bin/bash
# Terminal grouped evaluation wrapper for ablation_3_ds_contrastive.
...
EXPERIMENT_NAME="${3:-ablation_3_ds_contrastive}"
MODEL_DIR="${4:-output_v3/ablation_3_ds_contrastive}"
